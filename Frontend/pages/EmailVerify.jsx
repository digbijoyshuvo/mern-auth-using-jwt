  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-linear-to-br from-blue-200 to-purple-400'>
      ...
      <form onSubmit={onSubmitHandler} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
        ...
        <button className='w-full py-3 bg-linear-to-r from-indigo-500 to-indigo-900 text-white rounded-full font-semibold text-[16px] cursor-pointer'>Verify Email</button>
      </form>
    </div>
  )
}
